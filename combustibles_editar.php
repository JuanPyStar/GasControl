...
// Get ID of combustible to be edited
$id = isset($_GET['id']) ? $_GET['id'] : die('ERROR: ID no encontrado.');

// Set ID property of combustible to be edited
$combustible->id = $id;

// Read the details of combustible
$combustible->readOne();
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    // Set combustible property values
    ...
    if ($combustible->update()) {
        ...
        $message = "No se pudo actualizar el combustible.";
    }
}
...
<!-- Editar Combustible Content -->
<div class="fade-in">
    <div class="flex justify-between items-center mb-6">
        <h1 class="text-2xl font-bold text-gray-800">Editar Combustible</h1>
    ...
    <?php if (!empty($message)): ?>
        ...
        <?php if ($success): ?>
            <script>
                // Redirect to combustibles.php after 2 seconds
                setTimeout(function() {
        ...
        <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"] . '?id=' . $id); ?>" class="space-y-6">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <input type="text" name="tipo" id="tipo" value="<?php echo htmlspecialchars($combustible->tipo); ?>" required
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="number" name="precio_galon" id="precio_galon" step="0.01" min="0.01" value="<?php echo htmlspecialchars($combustible->precio_galon); ?>" required
            ...
            <div class="flex justify-end">
                ...
                <button type="submit" class="bg-blue-600 hover:bg-blue-700 text-white font-medium py-2 px-4 rounded-lg transition-colors">
                    <i class="fas fa-save mr-2"></i> Actualizar Combustible
                </button>
            </div>
        </form>
    </div>

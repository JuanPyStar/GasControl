...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($success) {
        $documento = urlencode($_POST['documento_cliente']);
        if (!isAdmin()) {
            // Si es empleado, regresa a ventas_agregar con el documento
            header("Location: ventas_agregar.php?documento_cliente=$documento");
            exit;
        } else {
            // Si es admin, se queda en clientes o redirige a listado de clientes
